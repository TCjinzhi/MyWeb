      ...
      <ul class="am-list admin-sidebar-list">
        ...
        <li class="admin-parent">
          ...
          <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav">
            <li><a href="<%=request.getContextPath()%>/personalInfo/personalCenter" class="am-cf"><span class="am-icon-check"></span> 个人资料<span class="am-icon-star am-fr am-margin-right admin-icon-yellow"></span></a></li>
            ...
            <div class="am-panel-bd">
              <div class="am-g">
                ...
                <div class="am-u-md-8">
                  ...
                  <form class="am-form" action="../personalInfo/uploadImage" enctype="multipart/form-data" method="post">
